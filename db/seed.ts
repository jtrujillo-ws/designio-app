 ...
 * Idempotente: si el workspace ya existe solo asegura las credenciales demo (cubre bases
 * sembradas antes de la migración de auth, cuyo backfill deja cuentas 'invitado' sin password).
...
async function main() {
  ...
  console.log(
    `seed: workspace Banco Andino creado (3 usuarios activos, 3 segmentos) — login demo: lucia@whitespace.demo / ${PASSWORD_DEMO}`,
  );
}
